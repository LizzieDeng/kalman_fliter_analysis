...
This module shows a function with enforced preconditions. It also
shows the preferred way to make error messages.
...
def last_name_first(n):
    ...
    assert n.count(' ') == 1, repr(n)+' has too many spaces'
