...
This module has a function stub to get us started.
...
def last_name_first(n):
    ...
    Precondition: n is a string in the form 'first-name last-name'
    with one or more spaces between the two names. There are no
