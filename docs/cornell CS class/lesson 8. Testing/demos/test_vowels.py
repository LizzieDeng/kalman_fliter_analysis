...
This module demonstrates the most primitive form of testing script.
It performs the tests directly, without wrapping them in a test
procedure.

This gives you an idea of the type of testing you might do with a
function. Believe it or not, this script does not have near enough
tests.
...
# Everything is ok
print('Module vowels passed all tests')
